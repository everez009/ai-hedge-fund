...
import { type FxPortfolioManagerNode } from '../types';
import { getStatusColor } from '../utils';
import { FxTradeSignalDialog } from './fx-trade-signal-dialog';
import { NodeShell } from './node-shell';

export function FxPortfolioManagerNode({
  data,
  selected,
  id,
  isConnectable,
}: NodeProps<FxPortfolioManagerNode>) {
  ...
  return (
    <>
      <NodeShell
        ...
        name={data.name || 'FX Portfolio Manager'}
